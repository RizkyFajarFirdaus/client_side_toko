<div class="container-fluid">
    ...
    <div class="col-lg-12 mb-4">
        ...
        <?php echo anchor(site_url('user/create'), '<i class="fa fa-flag" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger "'); ?>
                    ...
                    columns: [
                        {
                            "data": "id_users",
                            "orderable": false
                        },{"data": "full_name"},{"data": "email"},{"data": "id_user_level"},{"data": "is_aktif"},
                        {
                            "data" : "action",
                            "orderable": false,
